...
function Calcular(props) {
  ...
  const calcularDosificacion = (e) => {
    ...
    console.log('Resultado uno' + resUno);
    console.log('Resultado dos' + resDos);
      ...
      <div className="calcular">
        <div style={{width:'100%'}}>
          ...
          <Form>
              {props.valorVarilla ? 
                <div>
                  <h2><i class="lni-check-mark-circle"></i> VARILLA SELECCIONADA # {props.valorVarilla}</h2> 
                  <hr/>
                </div>
                :
          ...
          {props.valorVarilla ?
            <Form>
              ...
              <div>
                <h2><i class="lni-check-mark-circle"></i> SEPARACIÓN DEL EMPARRILLADO DE {props.valorEmparrillado} CM</h2> 
                <hr/>
              </div>
              :
